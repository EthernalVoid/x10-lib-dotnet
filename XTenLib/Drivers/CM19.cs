...
namespace XTenLib.Drivers
{
    ...
    {
        private UsbDeviceFinder MyUsbFinder = new UsbDeviceFinder(0x0BC7, 0x0002); // 0x0005 for CM21
        ...
        public bool Open()
        {
            ...
            try
            {
                ...
                /* CM21A initialization strings */
                //WriteData(new byte[] { 0x01, 0x00, 0x20, 0x14 });
                //WriteData(new byte[] { 0x01, 0x00, 0x20, 0x14, 0x20, 0x20, 0x20 });
            }
            catch (Exception e)
            {
                XTenManager.logger.Error(e);
